...
const Account = ({ route, navigation }) => {
    ...
    if (route.params.length == 1) {
        routeEmail = route.params.routeEmail;
    }
    else {
        routeEmail = route.params.routeEmail;
        routeLogin = route.params.routeLogin;
    }
                                    ...
                                    return (
                                        <View key={index}
                                            ...
                                            <TouchableRipple
                                                ...
                                                onPress={() => {
                                                    if (!stateSelectGenereId.includes(item.id)) {
                                                        if (stateSelectGenereId.length < 3
                                                        ) {
                                                            setStateSelectGenereId([
                                                                ...stateSelectGenereId,
                                                                item.id
                                                            ])
                                                        ...
                                                        let indexOfId = stateSelectGenereId.indexOf(item.id)
                                                        stateSelectGenereId.splice(indexOfId, 1)
                                                        let indexOfName = stateSelectGenere.indexOf(item.name)
                                                        stateSelectGenere.splice(indexOfName, 1)
                                                ...
                                                <>
                                                    ...
                                                    <SvgXml xml={stateSelectGenereId.includes(item.id)
